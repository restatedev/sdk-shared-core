...
pub mod start_message {
    #[allow(dead_code)]
    #[derive(Clone, PartialEq, Eq, Hash, ::restate_wire_derive::Message)]
...
#[allow(dead_code)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::restate_wire_derive::Message)]
...
pub mod propose_run_completion_message {
    ...
    #[derive(Clone, PartialEq, ::restate_wire_derive::Oneof)]
    pub enum Result {
        #[prost(bytes = "buffer", tag = "14")]
        Value(crate::Buffer),
...
pub mod notification_template {
    #[allow(dead_code)]
    #[allow(clippy::enum_variant_names)]
    #[derive(Clone, PartialEq, Eq, Hash, ::restate_wire_derive::Oneof)]
    pub enum Id {
        #[prost(uint32, tag = "1")]
        CompletionId(u32),
        #[prost(uint32, tag = "2")]
...
pub struct CallCommandMessage {
    ...
    #[prost(bytes = "buffer", tag = "3")]
    pub parameter: crate::Buffer,
    #[prost(message, repeated, tag = "4")]
    pub headers: ::prost::alloc::vec::Vec<Header>,
    /// If this invocation has a key associated (e.g. for objects and workflows), then this key is filled in. Empty otherwise.
    #[prost(string, tag = "5")]
...
#[derive(Clone, PartialEq, Eq, Hash, ::restate_wire_derive::Message)]
pub struct Value {
    #[prost(bytes = "buffer", tag = "1")]
    pub content: crate::Buffer,
}
...
#[allow(dead_code)]
#[allow(clippy::enum_variant_names)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::restate_wire_derive::Enumeration)]
#[repr(i32)]
